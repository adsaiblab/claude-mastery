...
POST /webhook/digest
Headers : X-Signature: hex digest hmac-sha256(SECRET, body)
Body    : { "date": "YYYY-MM-DD" }

Comportement :
- Vérifier HMAC en temps constant (`hmac.compare_digest`).
- Si invalide : 401, message générique.
- Si valide : utiliser idempotence + retry + DLQ comme la routine cron.
"""
...
def verify_signature(body: bytes, signature: str) -> bool:
    """TODO — calculer hmac.new(SECRET, body, sha256).hexdigest() et comparer
    avec compare_digest. Retourner True si match."""
